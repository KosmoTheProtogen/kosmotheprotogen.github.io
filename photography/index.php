<html lang="PL">
    <head>
        <meta charset="UTF-8">
        <title> Photography | Kosmo's Place</title>
    ...
    <body>
        ...
        <div class="nav" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="200">
            <a href="/">Home</a> <a href="/about">About Me</a> <a href="/hardware">Hardware</a> <a class="uarehere" href="/photography">Photography</a> <a href="/art">Art / Comics</a>
        </div>
        <div class="png" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
            <img src="/img/png.png">
        </div>
        <div class="welcome">
            <h1 data-aos="fade-down-right" data-aos-duration="1000" data-aos-delay="200">Photography</h1>
             <?php
